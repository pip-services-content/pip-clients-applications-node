# Development and Testing Guide <br/> Applications Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-content/pip-clients-applications-node.git
```
