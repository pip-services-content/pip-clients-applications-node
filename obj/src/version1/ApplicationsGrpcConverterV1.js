...
class ApplicationsGrpcConverterV1 {
    ...
    static toApplication(obj) {
        ...
        let application = {
            id: obj.getId(),
            name: new pip_services3_commons_node_1.MultiString(),
            description: new pip_services3_commons_node_1.MultiString(),
    ...
    static fromApplicationPage(page) {
        ...
        let data = _.map(page.data, ApplicationsGrpcConverterV1.fromApplication);
    ...
    static toApplicationPage(obj) {
        if (obj == null)
            return null;
        let data = _.map(obj.getDataList(), ApplicationsGrpcConverterV1.toApplication);
        let page = {
            total: obj.getTotal(),
            data: data
        };
